...
# Step 3: Clean old webui assets and install Motion binary system-wide
echo -e "${BLUE}📥 [3/6] Installing Motion binary system-wide...${NC}"
# Clean old webui assets to prevent accumulation of stale files
ssh "$PI_HOST" "sudo rm -rf $PI_WEBUI_PATH/assets/* 2>/dev/null" || true
